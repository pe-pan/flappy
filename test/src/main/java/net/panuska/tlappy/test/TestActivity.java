package net.panuska.tlappy.test;
...
import net.panuska.tlappy.BestScore;
import net.panuska.tlappy.TlappyActivity;
 ...
 */
public class TestActivity extends TlappyActivity {
